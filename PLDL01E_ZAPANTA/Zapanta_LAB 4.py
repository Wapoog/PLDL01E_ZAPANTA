...
class Employee:
    ...
    # intialization or constructor method of
    def __init__(self):
        # class Emplyee
        ...
        self.emp_rate_per_hour = float(input("Employee rate_per_hour"))
        ...
        self.emp_bum_tardiness = int(input("Employee tardiness"))

    def emp_sss_contriution(self):
        ...
        elif self.emp_gross_earnings >= 5720 and self.emp_gross_earnings < 6249.99:
        ...
        elif self.emp_gross_earnings >= 16705  and self.emp_gross_earnings < 17249.99:
